...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    Parameters
        symbol_quantity_list is a compound list returned from the parse_formula function. Each small list in symbol_quantity_list has this form: ["symbol", quantity].
